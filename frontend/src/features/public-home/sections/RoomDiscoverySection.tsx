        ...
        <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {rooms.slice(0, 6).map((room, idx) => {
            ...
            return (
              <Card
                key={room.id}
                className="group pt-0 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-200/50"
              >
                {/* Image / Header Preview */}
                <CardHeader className="relative h-56 w-full overflow-hidden bg-slate-100">
                  <Image
                    src={imageUrl}
                  ...
                  />
                  <div className="absolute inset-0 bg-linear-to-t from-slate-950/60 via-transparent to-black/20" />
